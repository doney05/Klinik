<div class="modal fade" id="pidio" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="pasienbaru" aria-hidden="true">
    ...
    <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/tambah/pidio')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/pidio/modaltambah.blade.php ENDPATH**/ ?>