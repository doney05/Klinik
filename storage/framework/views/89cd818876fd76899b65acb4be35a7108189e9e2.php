        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel" style="color: white">Edit Foto</h1>
...
<?php /**PATH C:\laragon\www\Klinik\resources\views/admin/master/poto/modaledit.blade.php ENDPATH**/ ?>